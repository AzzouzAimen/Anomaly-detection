#!/usr/bin/env python3
"""Load Sprint 2 ETL outputs into TimescaleDB via docker exec + psql."""
...
DEFAULT_CONTAINER = "apnea_timescaledb"
DEFAULT_DATABASE = "apnea_ts_db"
DEFAULT_USER = "user"
BATCH_SIZE = 100_000
...
def run_load(
    ...
    stage_start = time.perf_counter()
    enable_compression(container, database, user)
    ...
    write_summary_json(Path("database/timeseries/ingestion_log.json"), summary)
    return summary
